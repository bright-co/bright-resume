  ...
  return (
    <div className="flex flex-col min-h-screen">
      ...
      <main className="flex-1 pt-14">
        <section className="w-full py-12 md:py-24 lg:py-32 xl:py-48 bg-gradient-to-r from-purple-100 to-pink-100 dark:from-purple-900 dark:to-pink-900">
        ...
        <section
          id="features"
          className="w-full py-12 md:py-24 lg:py-32 bg-gradient-to-r from-green-100 to-blue-100 dark:from-green-900 dark:to-blue-900"
        >
          <div className="container px-4 md:px-6">
        ...
        <section
          id="testimonials"
          className="w-full py-12 md:py-24 lg:py-32 bg-gradient-to-r from-yellow-100 to-orange-100 dark:from-yellow-900 dark:to-orange-900"
        >
          <div className="container px-4 md:px-6">
            <h2 className="text-3xl font-bold tracking-tighter sm:text-4xl md:text-5xl text-center mb-8">
            ...
            <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-3">
              {TEXTS.testimonials.items.map((testimonial, index) => (
                <Card
                  key={index}
                  className="bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm overflow-hidden"
                >
        ...
        <section className="w-full py-12 md:py-24 lg:py-32 bg-gradient-to-r from-red-100 to-pink-100 dark:from-red-900 dark:to-pink-900">
          <div className="container px-4 md:px-6">
            <div className="flex flex-col items-center space-y-4 text-center">
              <div className="space-y-2">
        ...
        <section
          id="about"
          className="w-full py-12 md:py-24 lg:py-32 bg-gradient-to-r from-blue-100 to-cyan-100 dark:from-blue-900 dark:to-cyan-900"
        >
          <div className="container px-4 md:px-6">
            <div className="flex flex-col items-center space-y-4 text-center">
        ...
        <section
          id="contact"
          className="w-full py-12 md:py-24 lg:py-32 bg-gradient-to-r from-indigo-100 to-purple-100 dark:from-indigo-900 dark:to-purple-900"
        >
          <div className="container px-4 md:px-6">
            <div className="flex flex-col items-center space-y-4 text-center">
              <h2 className="text-3xl font-bold tracking-tighter sm:text-4xl md:text-5xl">
