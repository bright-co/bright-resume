...
export const Chat = () => {
  const { isOpenChat, setIsOpenChat } = useStudioContext();
  ...
  return (
    <Sheet open={isOpenChat} onOpenChange={setIsOpenChat}>
      ...
      <SheetContent style={{ width: 700, maxWidth: 700 }} side="right">
        <div className="flex flex-col w-full h-full">
          <ScrollArea className="flex-1 basis-0 w-full">
          ...
          <div className="flex items-center mb-3 px-5">
            <div className="flex items-center justify-center w-full space-x-2">
              <input
                className="flex h-10 w-full rounded-md border border-[#e5e7eb] px-3 py-2 text-sm placeholder-[#5b6a87] focus:outline-none focus:ring-2 focus:ring-[#9ca3af] disabled:cursor-not-allowed disabled:opacity-50 text-[#030712] focus-visible:ring-offset-2"
